...
class PersonalInsightsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PersonalInsightsScreen> createState() => _PersonalInsightsScreenState();
}
...
class _PersonalInsightsScreenState extends ConsumerState<PersonalInsightsScreen> {
  ...
  Widget _buildContent(List<CategoryModel> categories, List<ExpenseModel> expenses) {
    // 1. Group/Sum expenses by month
